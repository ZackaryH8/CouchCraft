...
interface UseHomePageOptions {
    ...
    toSidebar: () => void;
    push: (
        frame: { id: "create" } | { id: "instance"; instanceId: string },
    ) => void;
}
        ...
        (input: GamepadInput) => {
            ...
            switch (input) {
                ...
                case "RIGHT":
                    ...
                    break;
                case "A":
                    if (activeIndex === instances.length)
                        push({ id: "create" });
                    else {
                        const inst = instances[activeIndex];
                        if (inst) push({ id: "instance", instanceId: inst.id });
        ...
        <>
            {selectedInstance ? (
                <section
                    ...
                    style={
                        { "--accent": selectedInstance.color } as CSSProperties
                    }
                >
                    ...
                    <div className="relative flex items-end justify-between gap-8">
                        <div className="max-w-3xl">
                            ...
                            {selectedInstance.notes && (
                                <p className="mt-4 text-xl text-stone-200/85">
                                    {selectedInstance.notes}
                                </p>
                            )}
                            ...
                            <div className="mt-8 flex flex-wrap gap-4">
                                {[
                                    {
                                        label: "Minecraft",
                                        value: selectedInstance.minecraftVersion,
                                    },
                                    {
                                        label: "Mods",
                        ...
                        <div className="relative z-10 flex w-[22rem] shrink-0 flex-col gap-3">
                            ...
                            >
                                ...
                                >
                                    {account
                                        ? `Signed in as ${account.mcUsername}.`
                                        : "Not signed in."}{" "}
                                    Last played{" "}
                                    {formatLastPlayed(
                ...
                <section className="flex items-center justify-center rounded-[2rem] border border-dashed border-white/10 bg-[#111413] p-12">
                    <div className="text-center">
                        ...
                        <p className="mt-4 text-xl text-stone-400">
                            Press A on the New Instance card below to get
                            started.
                        </p>
                    </div>
                </section>
                            ...
                            >
                                ...
                                <div className="relative flex h-full flex-col">
                                    ...
                                    <div className="mt-6 space-y-3">
                                        ...
                                        <p className="min-h-14 text-base leading-7 text-stone-400">
                                            {instance.notes}
                                        </p>
                                    </div>
                                    ...
                                    <div className="mt-auto flex items-center justify-between pt-6 text-sm font-medium text-stone-300/85">
                                        <span>
                                            {formatModCount(instance.modCount)}
                                        </span>
                                        <span>
                                            {formatPlaytime(
